...
public class ProductController {
	...
	@Autowired
	private	ProductValidator productValidator; //combine both spring validation and bean validation
	...
	public void initialiseBinder(WebDataBinder binder) {
		...
		//chia: below is using addValidators, so that will not replace the existing validator list
